...
-- Dumping data for table pos_bunga.item_penjualan: ~25 rows (approximately)
...
INSERT INTO `produk` (`id`, `user_id`, `foto`, `nama`, `harga_beli`, `harga_jual`, `stok`, `created_at`, `updated_at`) VALUES
	...
	(4, 3, 'products/iOWrOUwwy1HOooh9zDBJ7I3bfbZokpysjjjRu7aT.jpg', 'Caramel Macchiato', 16500, 21100, 231, '2026-07-30 20:58:30', '2026-08-18 19:57:56'),
	...
	(11, 3, 'products/LwMHBP1Nf6iqKru10NYpxwAsjjEhHRLkxhLZG8xz.jpg', 'Cappuccino', 0, 26000, 838, '2026-07-30 23:56:33', '2026-08-28 00:12:51'),
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('dBMmJQHuYNorXpJmR68Fp5RXJqwLvJlKRRbPpSd6', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', '', 1787899802),
	('DiyiPDjGH4azVgbJyPIBiRwq7dmzEfwl6ggJDrU0', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', '', 1787901241);
...
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(2, 1, 'Jazlyn Gislason', 'lisa.borer@example.com', '2026-07-27 20:38:59', '$2y$12$gx4mVr7ouDyZ4tIdsueuu.8NKjglolYtCPgp9RqlXPbb2hamCxfcO', '9AMbMhCi2kuvjvoV63aK1ZQEkicsy4aVa3ARKLYUGyYE1nmb46dCgyBnSJde', '2026-07-27 20:38:59', '2026-07-27 20:38:59'),
	(3, 1, 'Wilbert Welch', 'elmo.kirlin@example.com', '2026-07-27 20:38:59', '$2y$12$gx4mVr7ouDyZ4tIdsueuu.8NKjglolYtCPgp9RqlXPbb2hamCxfcO', 'rDZMm8PMpGTbGBhUiADCWcf7ooe3tRhGxi3yeweNtIDQ63iftjtaMZkmq7zr', '2026-07-27 20:38:59', '2026-07-27 20:38:59'),
